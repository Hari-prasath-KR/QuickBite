...
import { 
  ...
  getAllBranches, 
  getAllStaff, 
  getCateringAnalytics, 
  updateBranch, 
  updateStaff,
  getCateringOrders,
  getCateringInventory
} from "../controllers/cateringAdminController.js";
...
router.get("/orders", requireAuth, getCateringOrders);
router.get("/inventory", requireAuth, getCateringInventory);
